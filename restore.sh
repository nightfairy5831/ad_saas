...
START_DATE="2025-07-7"  # YYYY-MM-DD
END_DATE="2025-10-24"    # YYYY-MM-DD
...
commit_messages=(
    "Initial commit"
    "Merge pull request from develop branch"
    "chore: adjust environment"
    "chore: update configuration"
    "feat: create visual editor"
    "feat: add remove button to campaign card"
    "feat: add archive button to campaign card"
    "feat: update widget.js content handling"
    "feat: update widget.js text structure"
    "fix: update widget.js"
    "fix: upgrade widget.js"
    "fix: update widget.js api endpoint"
    "fix: upgrade backend logic and widget.js"
    "fix: update endpoint to remove unnecessary field"
    "fix: remove unnecessary utm field"
    "fix: activate all utm parameters"
    "fix: update workflow to include text block field"
    "fix: update button name in campaign card"
    "fix: minor widget and campaign fixes"
