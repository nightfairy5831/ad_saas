            ...
            <Card className="shadow-sm">
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <div className="w-full bg-muted rounded-full h-2">
                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 h-2 rounded-full" style={{ width: '9.4%' }}></div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="w-full bg-muted rounded-full h-2">
                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 h-2 rounded-full" style={{ width: '12.3%' }}></div>
                  </div>
                </div>
              </CardContent>
            </Card>
